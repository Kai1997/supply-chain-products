		...
		return (
			<View style={styles.container}>
				<View style={styles.headerContainer}>
					<Text style={styles.heading}>APP PSCD</Text>
					{/* <Text style={styles.desc}></Text> */}
				</View>
				<View style={styles.faceContainer}>
					<Face icon="search" title="A" color="#E23f9c" />
					<Face icon="calendar" title="B" color="green" />
					<Face icon="cloud" title="C" color="blue" full />
					<Face icon="microphone" title="D" color="orange" />
				</View>
				<View>
					<CardHome
